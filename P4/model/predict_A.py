...
import torch
import numpy as np
# event_train = np.load('/home/user/liucheng/data/predict_event_all(404).npy')
#
#
# A_ture = np.load('/home/user/liucheng/data/ture_event(404).npy')
# A_last = np.load('/home/user/liucheng/data/last_A(404).npy')
